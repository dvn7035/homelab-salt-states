...
named.conf.options:
  file.managed:
    - name: /etc/bind9/named.conf.options
...
named.conf.local:
  file.managed:
    - name: /etc/bind9/named.conf.local
...
db.dvn7035.com:
  file.managed:
    - name: /etc/bind9/zones/db.dvn7035.com
...
db.168.192:
  file.managed:
    - name: /etc/bind9/zones/db.168.192
...
bind9_service:
  service.running:
    ...
    - watch:
      ...
      - file: /etc/bind9/zones/db.dvn7035.com
      - file: /etc/bind9/zones/db.168.192
